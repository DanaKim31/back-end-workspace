...
public class Application {
	...
	public void registerBook() {
		...
		// 등록에 성공하면 "성공적으로 책을 등록했습니다.",
		// 실패하면 "책을 등록하는데 실패했습니다." 출력
	}
	
	// 3. 책 삭제
	public void sellBook() {
		// printBookAll(전체 책 조회) 한 후
		// 삭제할 책 번호 선택을 사용자한테 입력받아 
		// 삭제에 성고하면 "성공적으로 책을 삭제했습니다.", 
	...
	public void registerMember() {
		...
		// 회원가입에 성공하면 "성공적으로 회원가입을 완료하였습니다.",
	...
	public void printRentBook() {
		...
		// 반납 번호, 책 제목, 책저자, 대여 날짜, 반납 기한 조회(JOIN필요)
	}
	
	// 3. 대여 취소
	public void deleteRent() {
		// printRentBook(내가 대여한 책 조회) 출력 후
		// 취소할 대여 번호를 사용자한테 입력 받아
		// 취소에 성공하면 "성공적으로 대여를 취소했습니다.",
		// 실패하면 "대여를 취소하는데 실패했습니다." 출력
	}
	
	// 5. 회원 탈퇴
	public void deleteMember() {
		// 회원탈퇴에 성공하면 "회원탈퇴 하였습니다 ㅠㅠ",
