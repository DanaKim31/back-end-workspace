...
public class FormServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 인코딩!! > 한글 처리 (request와 response 각각 설정)
...
//		String menu = request.getParameter("menu"); >> 여러개가 올 수 있기 때문에 리스트로 받아야 함 >> request.getParameterValues
		...
		pw.println("<p>당신의 성별은는 " + genderResult + "</p>");
