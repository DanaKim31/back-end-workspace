...
/*
 * 람다식(Lambda Expressions) => 자바 스크립트의 화살표 함수!
 * 	- 자바에서 함수적 프로그래밍을 위해서 자바 8부터 람다식을 지원  -> 객체 지향적
