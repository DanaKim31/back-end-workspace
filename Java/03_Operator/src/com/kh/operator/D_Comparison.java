...
//		d.method1();
	...
	public void method1() {
		...
		// 2로 나눴을 때의 나머지가 0인 경우 == 2로 나눠 떨어진다는 의미 == 짝수
		// 1인 경우 == 2로 나눠 떨어지지 않는다는 의미 == 홀수
	...
	public void method2() {
		...
		System.out.println("첫 번째 수가 두 번째 수보다 큽니까 : " + (num1 > num2));
		System.out.println("첫 번째 수가 짝수입니까 : " + (num1 % 2 == 0));
